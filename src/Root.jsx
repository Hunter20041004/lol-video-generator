...
const mockPlayerRadarData = {
  ...
  matchupSegment: {
    ...
    reasons: [
      ...
      { metric: "Vision", winnerValue: 1.8, loserValue: 1.1, delta: 0.7 },
    ],
  },
  proofSegment: {
    proofType: "mvp",
    ...
    player: {
      ...
      radarStats: [
        ...
        { label: "Vision", rawValue: "1.6", normalizedScore: 76 },
        { label: "Gold", rawValue: "418", normalizedScore: 88 },
      ],
    },
    proofReasons: [
      { metric: "KP%", rawValue: "81%", score: 94 },
      { metric: "KDA", rawValue: "9.4", score: 91 },
      { metric: "Gold", rawValue: "418", score: 88 },
    ],
