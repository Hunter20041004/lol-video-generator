  ...
  return (
    <AbsoluteFill>
      ...
      <div style={{ ...enterStyle(localFrame, 15, 12, reducedMotion), position: "absolute", left: SAFE_X, right: SAFE_X, top: 660 }}>
        ...
        <h2 style={{ font: `900 66px/1.3 ${TEXT_FONT}`, letterSpacing: -4, margin: "32px 0 0", maxWidth: 760 }}>{conclusionParts.lead}<br /><b style={{ color: COLORS.gold }}>{conclusionParts.emphasis}</b></h2>
